...
\[
\sum_{k=1}^{5} x_{i,k} \le 1 \quad \forall i
\]
...
res <- ranking_max_dp_heap_cpp(data_mat, k, max_par_groupe, beam_size = 5)
print(res)
```
...
# 5. Complexité des algorithmes (par le calcul)
