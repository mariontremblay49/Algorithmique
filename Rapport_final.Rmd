...
Avantages :
- Garantit d’obtenir la solution optimale, contrairement aux approches heuristiques.
- Flexible : on peut changer les poids par position ou les contraintes de groupes facilement.
...
result$selected_items |>
  ...
  kable(col.names = c("Position", "ID", "Score", "Groupe",
                      "Poids position", "Score pondéré"),
        align = "c",
        caption = "Tableau des éléments sélectionnés par l’algorithme ranking_max") |>
  kable_styling(
...
Le graphique montre que les positions les mieux pondérées (1 et 2) contribuent le plus au score total.

Permet de visualiser l’impact de chaque choix sur le score global.
